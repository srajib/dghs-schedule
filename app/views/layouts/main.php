                    ...
                    <ul id="nav">
                        <li ><a href=<?php echo site_url('schedule') ?>>Schedules</a>
                            <ul>
                                ...
                                <?php endif; ?>
                                <li><a href='<?php echo site_url('schedule/export') ?>'>Export Schedules</a>
                        ...
                        <li><a href=<?php echo site_url('venue') ?>>Venue</a>
                            <ul>
                                <li><a href=<?php echo site_url('venue') ?>>Manage Venue</a></li>
                        ...
                        <li><a href=<?php echo site_url('meeting') ?>>Meeting</a>
                            <ul>
                                <li><a href=<?php echo site_url('meeting') ?>>Manage Meeting</a></li>
                                <?php if ($this->session->userdata('userType') != USER): ?>
