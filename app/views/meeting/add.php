    ...
    <div class="block_content">
        ...
        <form action="" method="POST">
            <p class="adjacent same-row">
                ...
                <input id="startingDate" type="text" name="startingDate" class="text date_picker" value= "<?php echo set_value('startingDate')?>" />
            ...
            <p class="adjacent right">
                ...
                <input id="startingTime" type="text" name="startingTime" class="text small" value= "<?php echo set_value('startingTime')?>" />
                <span class='note error'>
            ...
            <p class="adjacent same-row">
                ...
                <input id="endingDate" type="text" name="endingDate" class="text date_picker" value= "<?php echo set_value('endingDate')?>" />
                <span class='note error'>
            ...
            <p class="adjacent right">
                ...
                <input id="endingTime" type="text" name="endingTime" class="text small" value= "<?php echo set_value('endingTime')?>" />
                <span class='note error'>
            ...
            <p>
                ...
                <input id="topic" type="text" name="topic" class="text large" value= "<?php echo set_value('topic')?>" />
                <span class='note error'>
             ...
             <p>
                ...
                <textarea id="description" name="description" class="textarea"><?php echo set_value('description')?></textarea>
            </p>
            <p class="adjacent same-row">
                <label for="venue_id">
                ...
                <select id="venue_id" name="venue_id" class="styled">
                    ...
                    <option value="<?php echo $venue['venue_id'] ?>" <?php echo set_select('venue_id', $venue['venue_id']) ?>><?php echo $venue['title'] ?></option>
                    <?php endforeach ?>
            ...
            <p class="adjacent right">
                ...
                <select id="group_id" name="group_id" class="styled">
                    ...
                    <option value="<?php echo $group['group_id'] ?>" <?php echo set_select('group_id', $group['group_id']) ?>><?php echo $group['associated_name'] ?></option>
                    <?php endforeach ?>
             ...
             <p>
                ...
                <input id="contact_person" type="text" name="contact_person" class="text large" value= "<?php echo set_value('contact_person')?>" />
                <span class='note error'>
