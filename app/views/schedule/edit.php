        ...
        <form action="" method="POST">
            ...
            <p>
                ...
                <span style="float: left; display: inline; padding-left: 100px">
                    ...
                    <input id="to_date" type="text" name="to_date" class="text date_picker" value= "<?php echo set_value('date',  DateHelper::mysqlToHuman($schedules['to_date'])) ?>"" />
                </span>
            </p>
            ...
            <p>
                ...
                <span style="float: left; display: inline; padding-left: 45px">
                    ...
                    <input id="to_time" type="text" name="to_time" class="text small" value= "<?php echo set_value('to_time', date("g:i a", STRTOTIME($schedules['to_time'])))?>" />
                 </span>
            </p>
