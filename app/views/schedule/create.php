<div class="block">
    ...
    <div class="block_content">
        ...
        <form action="" method="POST">
            <p>
                <b>All <span class="required">*</span> fields are required.</b>
            </p>

            <p>
                <span style="float: left; display: inline">
                    <label for="date" style="width: 80px">
                ...
                <span style="float: left; display: inline; padding-left: 100px">
                    <label for="to_date" >
                        To Date:
                    </label>

                    <input id="to_date" type="text" name="to_date" class="text date_picker" value= "<?php echo set_value('to_date')?>" />
                </span>
             ...
             <p>
                <span style="float: left; display: inline">
                 ...
                 <span style="float: left; display: inline; padding-left: 45px">
                    <label for="to_time">
                        To Time:
                    </label>

                    <input id="to_time" type="text" name="to_time" class="text small" value= "<?php echo set_value('to_time')?>" />
                 </span>
