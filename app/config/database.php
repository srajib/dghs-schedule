...
$db['production']['hostname'] = "103.247.238.164";
$db['production']['username'] = "scheduleDB"; // Production Database Name
$db['production']['password'] = "scheduleDB@2012"; // Production Database User Password
